...
public class SpendDbClient {
    ...
    private final CategoryDAOSpringJdbc categoryDAO = new CategoryDAOSpringJdbc(dataSource);
    private final SpendDAOSpringJdbc spendDAO = new SpendDAOSpringJdbc(dataSource);
